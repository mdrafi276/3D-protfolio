        ...
        <div className="  bg-gradient-to-tl from-[#010611] via-[#071C46] to-[#010611] p-10 h-full lg:h-[400px] flex flex-col items-center justify-center text-primary-content">
          <aside>
            ...
            <div className="flex gap-5 items-center justify-center mt-8">
              ...
              <a className="hover:underline font-bold" href="#work">
                Work
              </a>
              <a className="hover:underline font-bold" href="#contact">
                Contact
              </a>
              <a className="hover:underline font-bold" href="#skill">
                Skill
              </a>
            </div>
            <h1 className="text-center mt-2">mdrafi37473@gmail.com</h1>
            <h1 className="text-center mt-2">
              Copyright © 2023 - All right reserved
            </h1>
          </aside>
          <nav>
            <div className="flex mt-3 gap-4 md:flex-row">
              <a>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
